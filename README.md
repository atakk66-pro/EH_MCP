...
1. Build the bundle once (you, the maintainer):
   ```bash
   # name it after the manifest.json version, e.g. 0.3.1:
   npx -y @anthropic-ai/mcpb pack . "employment-hero-readonly-0.3.1.mcpb"
   ```
   Or just push a `v0.3.1` tag and let the release workflow build and publish it.
